...
print('lst2[1]["third"][0] =>', lst2[1]['third'][0])

lst3 = [['abc'], ['def'], {'third': ['ghi']}]

print('lst3[2]["third"][0][0] =>', lst3[2]['third'][0][0])

dict1 = {'a': ['d', 'e'], 'b': ['f', 'g'], 'c': ['h', 'i']}

print('dict1["b"][1] =>', dict1["b"][1])
...
print('list(dict2["3rd"].keys())[0] =>', list(dict2["3rd"].keys())[0])
